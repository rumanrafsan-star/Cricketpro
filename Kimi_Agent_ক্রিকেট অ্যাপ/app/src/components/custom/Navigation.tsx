          ...
          <div className="flex items-center justify-between">
            ...
            >
              <div className={`p-2 rounded-xl transition-all duration-300 ${
                isScrolled ? 'bg-[#f2d24b]' : 'bg-white/10 backdrop-blur-sm'
              }`}>
                <Trophy className={`w-6 h-6 ${isScrolled ? 'text-black' : 'text-[#f2d24b]'}`} />
              </div>
            ...
            <div className="hidden lg:block">
              <Button
                className={`rounded-full px-6 transition-all duration-300 ${
                  isScrolled
                    ? 'bg-[#f2d24b] hover:bg-[#e6c200] text-black'
          ...
          <div className="flex flex-col gap-2">
            {navLinks.map((link) => (
              <a
                ...
                className="px-4 py-3 text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-xl font-medium transition-colors"
              >
                {link.name}
              </a>
            ))}
            <Button className="mt-4 bg-[#f2d24b] hover:bg-[#e6c200] text-black rounded-full">
              Get App
            </Button>
          </div>
        </div>

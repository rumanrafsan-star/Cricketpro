      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-5xl sm:text-6xl font-bold text-white mb-4">
            FAN <span className="text-[#f2d24b]">POLLS</span>
          </h2>
              ...
              <Card key={poll.id} className="bg-gray-900 border-gray-800">
                <CardContent className="p-6">
                        ...
                        >
                          ...
                          {hasVoted && (
                            <div
                              className={`absolute inset-0 transition-all duration-1000 ${
                                isSelected ? 'bg-[#f2d24b]/30' : 'bg-gray-800/50'
                              }`}
                          ...
                          >
                            <div className="flex items-center gap-3">
                              {hasVoted && isSelected && (
                                <CheckCircle2 className="w-5 h-5 text-[#f2d24b]" />
                              )}
                              <span className={`font-medium ${hasVoted && isSelected ? 'text-[#f2d24b]' : 'text-white'}`}>
                                {option.text}
                              </span>
                            </div>
                            {hasVoted && (
                              <div className="flex items-center gap-3">
                                ...
                                <span className={`font-bold ${isSelected ? 'text-[#f2d24b]' : 'text-white'}`}>
                                  {percentage}%
                                </span>
                              </div>
                            )}
                  ...
                  <div className="flex items-center justify-between mt-6 pt-4 border-t border-gray-800">
                    ...
                    {hasVoted && (
                      <span className="text-sm text-[#f2d24b] flex items-center gap-1">
        ...
        <div className="grid sm:grid-cols-3 gap-6 mt-12">
          <div className="flex items-center gap-4 p-6 bg-gray-900/50 rounded-xl">
            <div className="w-12 h-12 rounded-full bg-[#f2d24b]/20 flex items-center justify-center">
              <BarChart3 className="w-6 h-6 text-[#f2d24b]" />
            </div>
            <div>

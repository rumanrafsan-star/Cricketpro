        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              {/* Badge */}
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#f2d24b]/20 backdrop-blur-sm rounded-full border border-[#f2d24b]/30">
                <span className="w-2 h-2 bg-[#f2d24b] rounded-full animate-pulse" />
                <span className="text-[#f2d24b] text-sm font-medium tracking-wide">
              ...
              <div className="flex flex-wrap gap-4">
                <Button
                  ...
                  className="bg-[#f2d24b] hover:bg-[#e6c200] text-black font-semibold px-8 py-6 text-lg rounded-full transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-[#f2d24b]/30"
                >
              ...
              <div className="flex flex-wrap gap-8 pt-8 border-t border-white/10">
                <div className="space-y-1">
                  <p className="text-3xl font-bold text-[#f2d24b]">50+</p>
                  <p className="text-sm text-gray-400">Live Matches</p>
                </div>
                <div className="space-y-1">
                  <p className="text-3xl font-bold text-[#f2d24b]">10K+</p>
                  <p className="text-sm text-gray-400">Players</p>
                </div>
                <div className="space-y-1">
                  <p className="text-3xl font-bold text-[#f2d24b]">1M+</p>
            ...
            <div className="hidden lg:flex justify-center items-end relative">
              ...
              >
                ...
                />
                {/* Glow Effect */}
                <div className="absolute -inset-10 bg-[#f2d24b]/20 blur-3xl rounded-full -z-10" />
              </div>
            </div>
          </div>
        </div>

...
export default function TeamGrid() {
  ...
  const getTeamStats = (team: Team) => {
    ...
    return stats[team.name as keyof typeof stats] || { titles: 0, matches: 0, winRate: 0 };
  };

  return (
    <section id="fixtures" className="py-20 bg-white">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="p-4 bg-gray-50 rounded-xl text-center">
                        <Trophy className="w-6 h-6 mx-auto mb-2 text-[#f2d24b]" />
                        <p className="text-2xl font-bold">{stats.titles}</p>
                        <p className="text-xs text-gray-500">ICC Titles</p>
                      </div>
                      <div className="p-4 bg-gray-50 rounded-xl text-center">

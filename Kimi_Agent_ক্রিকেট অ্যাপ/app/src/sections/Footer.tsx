  ...
  return (
    <footer className="bg-[#0a0a0a] text-white">
      ...
      <div className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-[#f2d24b]/10 to-transparent" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="space-y-4">
              <h2 className="text-4xl sm:text-5xl font-bold">
                NEVER MISS A <span className="text-[#f2d24b]">MATCH</span>
              </h2>
            ...
            <div className="flex gap-3">
              ...
              />
              <Button className="bg-[#f2d24b] hover:bg-[#e6c200] text-black h-14 px-8 rounded-full font-semibold">
                Subscribe
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
            ...
            <div className="col-span-2 md:col-span-4 lg:col-span-1 space-y-6">
              <a href="#home" className="flex items-center gap-2">
                <div className="p-2 bg-[#f2d24b] rounded-xl">
                  <Trophy className="w-6 h-6 text-black" />
                </div>
                <span className="text-2xl font-bold">
                  Cricket<span className="text-[#f2d24b]">Pro</span>
                </span>
              </a>
              ...
              <div className="flex gap-3">
                {socialLinks.map((social) => (
                  <a
                    key={social.name}
                    href={social.href}
                    className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#f2d24b] hover:text-black transition-all"
                  >
                  ...
                  {links.map((link) => (
                    <li key={link.name}>
                      <a
                        ...
                        className="text-gray-400 hover:text-[#f2d24b] transition-colors text-sm"
                      >
                        {link.name}
                      </a>
                    </li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-2 text-gray-400 text-sm">
                  <Mail className="w-4 h-4 text-[#f2d24b]" />
                  info@cricketpro.com
                </li>
                <li className="flex items-center gap-2 text-gray-400 text-sm">
                  <Phone className="w-4 h-4 text-[#f2d24b]" />
                  +1 234 567 890
                </li>
                <li className="flex items-start gap-2 text-gray-400 text-sm">
                  <MapPin className="w-4 h-4 text-[#f2d24b] mt-0.5" />
